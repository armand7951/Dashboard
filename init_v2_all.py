...
def initialize_all_v2():
    ...
    for project in projects:
        doc_id = project["id"]
        url = f"https://firestore.googleapis.com/v1/projects/{PROJECT_ID}/databases/{DATABASE_ID}/documents/projects/{doc_id}?updateMask.fieldPaths=agentActive&updateMask.fieldPaths=agentLogs"
        
        # Gather gets the real scan result
